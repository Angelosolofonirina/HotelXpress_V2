...
import Reserver from './datereservation/Reserver';
import { Link } from "react-router-dom";
import HeaderReservation from './headerReservation/HeaderReservation'
...
const Reservation = () => {
  ...
  return (
    ...
    <HeaderReservation/>
      ...
      <Link to='/payment' id='payment'><button value='button'>Payer</button></Link>
      </div>
      </div>
      </form>
      <Reserver/>
